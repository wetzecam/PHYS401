...
public class PlanetRApp extends AbstractSimulation {

    PlotFrame frame = new PlotFrame("x", "y", "Kepler Orbit");

    MovingRObject planet = new MovingRObject();
  ...
  public void reset() {
    ...
    control.setValue("vx",  0.0);
    control.setValue("y",  0.0);
    control.setValue("vy", -0.40);
  ...
  public static void main(String[] args) {
    SimulationControl.createApp(new PlanetRApp());
  }
}
