...
/**
 * MarkerAreaApp demonstrates how to use a dataset with the BAR marker style.
 *
...
public class MarkerBarApp {
  ...
  public static void main(String[] args) {
    ...
    PlottingPanel panel = new PlottingPanel("x", "y", "Bar Marker");
    ...
    for(int i = 0;i<16;i++) {
      double x = (-8+i)*0.2;
      dataset.append(x, Math.exp(-x*x*4.0));
    }
