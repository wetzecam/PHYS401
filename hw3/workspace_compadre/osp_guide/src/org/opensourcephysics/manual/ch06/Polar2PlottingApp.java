...
/**
 * Polar2PlottingApp demonstrates how to create a plotting panel with polar coordinate axes.
 */
public class Polar2PlottingApp {
  ...
  public static void main(String[] args) {
    ...
    plotPanel.setPreferredMinMax(0, 20, -10, 10);
    plotPanel.setSquareAspect(true);
    ...
    PolarType2 axes = new PolarType2(plotPanel);
    axes.setDeltaR(1);
