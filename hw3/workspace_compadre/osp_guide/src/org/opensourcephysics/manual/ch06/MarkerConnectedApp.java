...
/**
 * MarkerConnectedApp demonstrates how to use a dataset with connected segments.
 *
 * @author Wolfgang Christian
 * @version 1.0
 */
public class MarkerConnectedApp {
  public static void main(String[] args) {
    PlottingPanel panel = new PlottingPanel("x", "y", "Connected Line");
    ...
    for(int i = 0;i<200;i++) {
      double x = Math.PI*(-100+i)*0.03;
      dataset.append(x, Math.sin(x)*Math.sin(x)/x/x);
    }
