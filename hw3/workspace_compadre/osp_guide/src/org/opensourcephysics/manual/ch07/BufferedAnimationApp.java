 ...
 * @version 1.0
 */
public class BufferedAnimationApp extends AbstractAnimation {
  DrawingPanel panel = new DrawingPanel();
  DrawingFrame frame = new DrawingFrame("Buffered Drawing", panel);
  ...
  /**
   * Constructs a BufferedAnimationApp.
   */
  public BufferedAnimationApp() {
    panel.setPreferredMinMax(-5, 5, -5, 5);
    panel.addDrawable(spiral);
    panel.setBuffered(true); // creates offscree buffer
  ...
  public static void main(String[] args) {
    AnimationControl.createApp(new BufferedAnimationApp());
  }
}
