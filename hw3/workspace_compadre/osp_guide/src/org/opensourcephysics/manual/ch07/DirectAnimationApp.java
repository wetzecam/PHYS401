...
/**
 * DirectAnimationApp tests the frame rate and the animation quality
 * by invoking the repaint method.  The drawing is rendered from within the event dispatch thread
 * when the component is painted.
 *
 * @author W. Christian
 * @version 1.0
 */
public class DirectAnimationApp extends AbstractAnimation {
  ...
  /**
   * Constructs a DirectAnimationApp.
   */
  public DirectAnimationApp() {
  ...
  public void stopAnimation() {
    ...
    super.stopAnimation();
    panel.repaint();
    control.println("frames pr second="+1000*rate);
  ...
  public static void main(String[] args) {
    AnimationControl.createApp(new DirectAnimationApp());
  }
}
