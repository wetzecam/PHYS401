...
/**
 * GaussianContourApp demonstrates how to plot a gaussian
 * scalar field using the Contour class.
 *
 * @author       Wolfgang Christian
 * @version 1.0
 */
public class GaussianContourApp {
  public static void main(String[] args) {
    ...
    ContourPlot field = new ContourPlot(pointdata);
