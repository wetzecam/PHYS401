...
public class CalcSurfacePlotApp implements Calculation {
  ...
  */
  ...
  public void calculate() {
    ...
    field = new SurfacePlot(pointdata);
    ...
    SurfacePlotMouseController mouseController = new SurfacePlotMouseController(drawingPanel, field);
    drawingPanel.addMouseListener(mouseController);
    drawingPanel.addMouseMotionListener(mouseController);
  }

  public static void main(String[] args) {
    Calculation model = new CalcSurfacePlotApp();
