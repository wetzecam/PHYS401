...
/**
 * GaussianInterpolatedApp demonstrates how to plot a gaussian
 * scalar field using an InterpolatedPlot.
 *
 * @author       Wolfgang Christian
 * @version 1.0
 */
public class GaussianInterpolatedApp {
  public static void main(String[] args) {
    ...
    InterpolatedPlot field = new InterpolatedPlot(pointdata);
