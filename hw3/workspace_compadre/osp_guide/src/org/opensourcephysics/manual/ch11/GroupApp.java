...
/**
 * GroupApp demonstrates how a OSP 3D can be positioned as a single object.
 *
...
public class GroupApp {
  ...
  static public void main(String args[]) {
    Display3DFrame frame = new Display3DFrame("Group Demo");
    ...
    while(true) {                        // animate until the program exits
      ...
      group.setTransformation(rotation); // group rotates as a unit
      frame.render();
    }
  }
}
