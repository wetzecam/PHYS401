...
public class PI extends AbstractCalculation{
  ...
  public void calculate(){
    ...
    /*
    try{
      FileWriter ofile = new FileWriter("PIdata16_new.txt");
      BufferedWriter oss = new BufferedWriter(ofile);
  ...
  public static void main(String[] args){
    CalculationControl control = CalculationControl.createApp(new PI());
  }
